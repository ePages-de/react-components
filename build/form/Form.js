...
var _FormValueScope2 = require('./FormValueScope');
...
var Form = function (_FormValueScope) {
  ...
  _createClass(Form, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['name', 'value', 'onSubmit', 'onChange', 'prepare', 'validate', 'normalize', 'children']); // eslint-disable-line no-unused-vars
