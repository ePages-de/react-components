  ...
  render() {
    ...
    const dimension =
      orientation === 'horizontal'
        ? {
            width: itemSize * itemCount + itemSpacing * (itemCount - 1),
            height: crossAxisItemSize
          }
        : {
            height: itemSize * itemCount + itemSpacing * (itemCount - 1),
            width: crossAxisItemSize
          }
            ...
            <div
              ...
              onDragEnter={() => {
                if (
                  dragIndex !== null &&
                  dragIndex !== index &&
                  validate(swap(value, dragIndex, index))
                ) {
              ...
              onDragOver={event => {
                if (
                  !itemWithDndInfo.get('__isDisabled') &&
                  dragIndex !== null &&
                  dragIndex !== index &&
                  validate(swap(value, dragIndex, index))
                ) {
